...
class PenstateDatasetSA(Dataset):
    ...
    def __init__(self,
                 ...
                 face_mean_path=None,
                 face_std_path=None):
        super(PenstateDatasetSA, self).__init__()
        ...
        if faces_path is None:
            ...
            self.faces = np.loadtxt(faces_path)
    ...
    def get_data(self,):
        ...
        for line in lines:
            ...
            face = np.loadtxt(face_path).T.flatten()
    ...
    def get_faces(self,):
        # compute mean and std
        assert self.mode == 'train'
        faces = [(info['face'] - self.face_mean) / self.face_std
